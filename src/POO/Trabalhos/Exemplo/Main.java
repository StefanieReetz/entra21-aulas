...
import POO.Trabalhos.Exemplo.Gerenciadores.GerenciadorAstronauta;
import POO.Trabalhos.Exemplo.Gerenciadores.GerenciadorMissao;
import POO.Trabalhos.Exemplo.Gerenciadores.GerenciadorNave;
...
public class Main {
    public static void main(String[] args) {
        ...
        GerenciadorMissao gerenciadorMissao = new GerenciadorMissao(gerenciadorNave, gerenciadorAstronauta);
        ...
        gerenciadorAstronauta.adicionarAstronauta("Fernanda", "voar");
        gerenciadorMissao.adicionarMissao("Terra", "Ir para terra", "06/05", StatusMissao.CANCELADA);
        gerenciadorMissao.adicionarMissao("Terra", "Ir para terra", "06/05", StatusMissao.CONCLUIDA);
        ...
        do {
            ...
            switch (opcao){
                case 1:
                    ...
                    gerenciadorMissao.adicionarMissao(nomeMissao, objetivoMissao, dataLancamento, statusMissao);
                    break;
                ...
                case 4:
                    gerenciadorMissao.listarMissoes();
                ...
                case 7:
                    ...
                    scanner.nextLine();
                    gerenciadorMissao.associarNaveAMissao(idMissaoAssocNave, idNaveAssoc);
                    break;
                ...
                case 8:
                    ...
                    scanner.nextLine();
                    gerenciadorMissao.associarAstronautaAMissao(idMissaoAssocAstronauta, idAstronautaAssoc);
                ...
                case 9:
                    ...
                    gerenciadorMissao.atualizarStatusMissao(idMissaoAtualizar, novoStatus);
